...
/*
NAME validity.php (mobil) is part of the voucher4guests Project
...
<div class="normal_view"><a href="../validity.php<?php echo '?lang='.$language.'&add='.$add.'&mobil=off&ssl='.$ssl ?>"><?php echo $lang['SwitchView']; ?></a></div>
       ...
       <?php
		 ...
		 ?>     
           <form name="Formular" action="validity.php<?php echo '?lang='.$language.'&add='.$add.'&mobil='.$mobil.'&ssl='.$ssl; ?>" method="post" onsubmit="return chkFormular()">    
		        <input type="submit" class="submit" value='<?php echo $lang["Logout"]; ?>' name="logout" style="float:left;" />
		     </form> 
		 <?php } ?> 
		 </p>
		 <p>&nbsp;</p> 
