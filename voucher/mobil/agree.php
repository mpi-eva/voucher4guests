...
/*
NAME agree.php (mobil) is part of the voucher4guests Project
...
<div class="normal_view"><a href="../agree.php<?php echo '?lang='.$language ?>"><?php echo $lang['SwitchView']; ?></a></div>
