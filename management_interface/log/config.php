<?php
/*
this config file is prepared for voucher4guests project
*/
...
$CFG['ViewMessageCharacterLimit'] = 120;		// Default character limit for the message gets trunscated! 0 means NO trunscation.
...
$CFG['Sources']['Source1']['ID'] = 'Source1';
$CFG['Sources']['Source1']['Name'] = 'Local Syslog Source';
$CFG['Sources']['Source1']['ViewID'] = 'SYSLOG';
...
$CFG['Sources']['Source1']['DBPassword'] = 'INSERTPASSWORD';
